...
- Rust :: example of LLVM usage, interesting compiler, I like language design
- GHC :: interesting compiler, very interesting language (though I don't like dependent type direction)
