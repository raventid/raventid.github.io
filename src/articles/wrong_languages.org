#+title: Wrong programming languages to learn

I've always been notoriously bad in selecting programming languages to learn. I've started with QBasic and Pascal a long time ago and I've tried about 60+ different programming languages. Here I'm gonna explain you why it might be a really bad hobby which leads to a lack of time and depression.

First, I want to say, if you are a programming language fan like me and you just cannot calmly seet when you know that some programming language you never tried exists - feel free to skip this article you know what I'm going to say.
...
When you programm in one programming language you learn ecosystem, you learn microtactics to solve particular problems and every day your brains forms intuitive patterns.

Need to write test? You remeber your favourite framework API. Need to pass a dependency? You know how to do it in your language. Need to type new code and solve a typicall problem? Pass a logger, instantate class, use Fabric Method. You know what idioms your language use to increase performance, heck you know your language idioms - you've read a tons of articles about it.

Now, imagine your are starting to spend more time in a new programming language. For example let's imagine that you are Java developer and you learning Rust.

This is a totally fine code in Rust

#+begin_src rust
fn check(r : Result<u8>) -> u8 {
  match r {
    Some(val) => val,
    None => 0
  }
...
It's easier to live this way. Have something complex, unstudied. Something you cannot quickly understand. And most important - something that might act unpredictably. Like any not fully understood entity of a real world.

Smalltalk was a great system, interesting, fascinting, but promoting this morbid idea.

But understand me well - there are two parts of me artists and engineer. As an artist I appreciate Ruby programming language that proudly proclaims "Ruby is simple in appearance, but is very complex inside, just like our human body."[fn:1], but as an engineer I question that and aim for simplicity and transperancy.

Let's not move away from our topic which is Stuying Languages. What I am saying here is many language have their own philosophies, and because general purpose language is good for everything you will most probably be able to use one programming language or other to solve the same problem. So not only you need to study programming language design, ecosystem, but also embrace philosophy and follow it. Like they say with kung fu schools - master one and add elements of others to form your style. So yes, you can create your own programming language, by taking your favourite one as a foundation and adding elements of others. But you should not study 10 different language and randomly apply different philosophies, technics and ideas to a poor program you are writing.

The same way as Object Oriented programming pushing us toward a very complicated design of Objects

* Footnotes

[fn:1] Matz, speaking on the Ruby-Talk mailing list, May 12th, 2000.
